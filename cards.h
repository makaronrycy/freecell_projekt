...
const char help_text[] = "\nZasady gry:\n\n1) Plansza sk�ada sie z 3 grup p�l:\n   a) grupa \"docelowa\" - sklada sie z czterech p�l, trzeba na nich posortowac od najmniejszego(asa) do najwiekszego(krola) karty tego samego znaczka (cztery pola cztery znaczki), z tej grupy nie wolno zdejmowac kart\n   b) grupa \"pomocnicza\" - sklada sie z czterech p�l, mozna na kazdym z czterech pol polozyc dowolna karte, nie mozna stackowac kart na sobie, mozna zdejmowac karty w dowolnym momencie\n   c) grupa \"pole gry\" - sklada sie z osmiu p�l, na poczatku gry losowane sa karty, na pierwszych czterech polach lezy 7 rozlosowanych kart na pozostalych 6 rozlosowanych kart, z kazdego pola mozna zdejmowac karte znajdujaca sie na wierzchu, natomiast po�o�y� kart� na polu mo�na tylko wtedy, gdy karta na kt�r� k�adziemy, jest przeciwnego koloru (czarny/czerwony) i o jednostk� wy�sza od karty k�adzionej. na przyk�ad na kr�la kier mo�na po�o�y� tylko dam� pik lub dam� trefl. Na puste pole mo�na po�o�y� dowoln� kart�.\n\n2) Dozwolone ruchy:\n- Przeniesienie karty z pola gry na inne pole gry;\n- Przeniesienie karty z pola gry do grupy p�l pomocniczych\n- Przeniesienie karty z grupy p�l pomocniczych na pole gry\n- Przeniesienie karty z pola gry do grupy p�l docelowych\n- Przeniesienie karty z grupy p�l pomocniczych do grupy p�l docelowych.\n\n3) Pora�ka:\nCzasami zdarza sie, �e nie jest mo�liwe wykonanie ruchu zgodnego z zasadami gry. Freecella uznaje si� wtedy za przegranego.\nNie ka�de rozdanie FreeCella jest mo�liwe do u�o�enia.\n\nPrzyk�adowe komendy:\ng1g2 - przenosi z kolumny pierwszej grupy g��wnej na kolumne drug�\ng1p - przenosi z kolumny pierwszej grupy g��wnej do grupy pomocniczej\np1g1 - przenosi z pierwszej kolumny pomocniczej na pierwsza kolumne grupy g��wnej\ng1d - przenosi z grupy g��wnej kolumny pierwszej na grup� docelow�\n";
